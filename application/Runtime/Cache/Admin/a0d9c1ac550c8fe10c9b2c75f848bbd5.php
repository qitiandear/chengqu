...
<html>
  ...
  <body>
    <h3 align="center">文章修改</h3>
        <form name="frm" method="post" action="/chengqu/admin.php/AddNews/update/articleId/<?php echo ($new["0"]["id"]); ?>" enctype="multipart/form-data" onsubmit="return checkAdd()">
        <table class="addNewsTb" bgcolor="#DCDCDC" border="0" align="center" width="700">
          ...
          <tr>
            <td>文章来源：</td>
            <td><input type="text" name="source" size="50" value="<?php echo ($new["0"]["source"]); ?>"></td>
          </tr>
          <tr>
