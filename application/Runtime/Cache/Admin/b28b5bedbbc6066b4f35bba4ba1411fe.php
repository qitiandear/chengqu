...
function del(id){
	if(confirm("是否删除该记录")){
		window.location = '/admin.php/Trend/delete/id/'+id;
	}
}
</script>
<script>
    ...
    console.log(vals);
      ...
      if(confirm("是否删除")){
        // document.getElementById("taken_").innerHTML = "<span style='color:green;'>已还书</span>";
         window.location = '/admin.php/Trend/deleted/id/'+vals;
        }
...
<h3 align="center">网际导航管理</h3>
    ...
    <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
			...
			<td>
					<a href="/admin.php/Trend/update/id/<?php echo ($v["id"]); ?>">修改</a>
					&nbsp;&nbsp;&nbsp;
