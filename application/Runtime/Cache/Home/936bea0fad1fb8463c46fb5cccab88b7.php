					...
					<div class="jinchaneir">
						<div class="jinchaneirnei">
							<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="lrc_onelist">
								...
								<?php if($v['typeId'] == 19): ?><a href="/index.php/News/cqzx/id/<?php echo ($v["id"]); ?>" class="ie6neir"> <?php echo ($v["title"]); ?></a>				<span class="ie6date"><?php echo ($v["date"]); ?></span>
								<?php else: ?>
								
								<a href="/index.php/News/index/id/<?php echo ($v["id"]); ?>" class="ie6neir"> <?php echo ($v["title"]); ?></a>				<span class="ie6date"><?php echo ($v["date"]); ?></span><?php endif; ?>
							</div><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
				</div>
