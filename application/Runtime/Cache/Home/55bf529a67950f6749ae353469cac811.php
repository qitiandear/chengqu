...
<div class="ui-popup" id="clink">
	...
	<div class="lrc_neirongqu">
		<div class="lrc_neirongqunei">
			...
			<div class="lrc_neirongquright">
				<div class="lrc_tzlm">
					<b style="margin-left:5px"><?php echo ($tpz["typeName"]); ?></b>
	  	...
	  	<br>
	  	<div class="newsImg">
	  	<!--<?php if($news["imagepath"] != NULL ): ?><img src="/chengqu/public/<?php echo ($news["imagepath"]); ?>" width="700"  ><?php endif; ?>-->
		  </div>
	 	...
	 	<!--  <div class="unit"><?php echo ($news["fenju"]); ?><br/><?php echo ($news["date"]); ?></div> -->
			...
			<!-- 	 <div style="margin-left:35%;">
				   	   <a href="/chengqu/index.php/News/sig/id/<?php echo ($news["id"]); ?>"><input type="button" value="签收 " style="background:#1091EA;border:0px;cursor:pointer;"/></a>
				   
				   <a href="/chengqu/index.php/News/signed/id/<?php echo ($news["id"]); ?>"><input type="button" value="签收明细  " style="cursor:pointer;" /></a>
				   </div> -->
	...
	<div class="fall">
			上一篇：
			<?php if($snew["title"] != NULL ): ?><a href="/chengqu/index.php/News/index/id/<?php echo ($snew["id"]); ?>" style="cursor:pointer;"><?php echo ($snew["title"]); ?></a>
				<?php else: ?>
				没有上一篇<?php endif; ?>
			
	   <br/>下一篇：
		<?php if($xnew["title"] != NULL ): ?><a href="/chengqu/index.php/News/index/id/<?php echo ($xnew["id"]); ?>" style="cursor:pointer;"><?php echo ($xnew["title"]); ?></a>
				<?php else: ?>
				没有下一篇<?php endif; ?>
	   
	   <br/><br/><br/><br/>
	<?php if($news['typeId']==4 || $news['typeId']==5 || $news['typeId']==6): ?><form name="frm" name="myform" action="/chengqu/index.php/News/sig/id/<?php echo ($news["id"]); ?>"  method="post" onsubmit="return checkAdd()">
	  ...
	  <input type="button" value="签收明细" onclick="qianshou(<?php echo ($news["id"]); ?>)"/>
	   </form> <br/><br/><br/><br/><br/><br/><?php endif; ?>

			</div>
			<script>
				function qianshou(id){
					window.location = "/chengqu/index.php/News/signed/id/"+id;
				}
			</script>
	<!-- 分页部分开始 -->
		<script>
