			...
			<div class="lrc_neirongquright">
				...
				<div class="jinchaneir">
					<div class="jinchaneirnei">
						<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="lrc_onelist">
							<!-- <span class="ie6sanjiao"></span> -->
							<a href="/chengqu/index.php/News/index/id/<?php echo ($v["id"]); ?>" class="ie6neir"> <?php echo ($v["title"]); ?></a>				<span class="ie6date"><?php echo ($v["date"]); ?></span>
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div>
			</div>
