...
<br/>
	<table width="960"  cellpadding="1" cellspacing="0" align="center" style="margin-left: 16.5%;">
	...
	<?php if(is_array($arr)): $k = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr style="background-color:<?php echo $k%2==NULL?'#FFFFFF':'#F1F5FE';?>">
		<td><a href="/index.php/Division/liste/id/<?php echo ($v["id"]); ?>"><?php echo ($v["username"]); ?></a></td>
		
		<td><?php echo ($v["c"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
	</tr>
	</volist>
</table>
<br/><br/>
